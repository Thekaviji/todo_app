        ...
        child: ListView(
          ...
          children: [
            ...
            DropdownButtonFormField<TaskPriority>(
              ...
              style: GoogleFonts.roboto(fontSize: 15, color: Theme.of(context).colorScheme.onSurface),
              items: TaskPriority.values.map((p) {
                return DropdownMenuItem(
                  value: p,
                  child: Text(
                    p.name[0].toUpperCase() + p.name.substring(1),
                    style: GoogleFonts.roboto(fontWeight: FontWeight.w500, color: Theme.of(context).colorScheme.onSurface),
                  ),
                );
              }).toList(),
